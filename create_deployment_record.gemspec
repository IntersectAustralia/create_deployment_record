...
Gem::Specification.new do |s|
  ...
  s.authors = ["danieltheodosius", "honsq90"]
  s.date = "2013-09-04"
  s.description = "Capistrano task to create deployment record"
  s.email = "danielt@intersect.org.au"
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  ...
  s.summary = "Capistrano task to create deployment record"
